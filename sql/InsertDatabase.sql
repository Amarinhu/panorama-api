...
-- Tarefas Weekly
INSERT INTO tarefa (id_grupo, nome, inicio, fim, descricao, dificuldade, concluido, criado_em, atualizado_em, ativo) VALUES
(@grupo_weekly, 'Limpar garagem', GETDATE(), NULL, 'Organizar e limpar a garagem', 3, 0, GETDATE(), GETDATE(), 1),
(@grupo_weekly, 'Revisar orçamento', GETDATE(), NULL, 'Verificar gastos da semana', 2, 0, GETDATE(), GETDATE(), 1);
...
INSERT INTO tarefa_atributo (id_tarefa, id_atributo, criado_em, atualizado_em, ativo) VALUES
(@tarefa1, @forca, GETDATE(), GETDATE(), 1),
(@tarefa2, @inteligencia, GETDATE(), GETDATE(), 1);

-- Tarefas Daily
INSERT INTO tarefa (id_grupo, nome, inicio, fim, descricao, dificuldade, concluido, criado_em, atualizado_em, ativo) VALUES
(@grupo_daily, 'Meditar', GETDATE(), NULL, 'Meditar por 10 minutos', 1, 0, GETDATE(), GETDATE(), 1),
(@grupo_daily, 'Alongar', GETDATE(), NULL, 'Alongamento matinal', 1, 0, GETDATE(), GETDATE(), 1);
...
-- Tarefas Monthly
INSERT INTO tarefa (id_grupo, nome, inicio, fim, descricao, dificuldade, concluido, criado_em, atualizado_em, ativo) VALUES
(@grupo_monthly, 'Reunião familiar', GETDATE(), NULL, 'Organizar encontro familiar', 2, 0, GETDATE(), GETDATE(), 1),
(@grupo_monthly, 'Curso online', GETDATE(), NULL, 'Completar módulo do curso online', 4, 0, GETDATE(), GETDATE(), 1);
